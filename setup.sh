...
echo ""
echo "   All scripts automatically use the virtual environment:"
echo ""
...
echo "   ./talk \"build an API\"   # Natural language interface"
echo "   ./run                    # Main orchestrator"
echo ""
echo "💡 Optional: Manually activate venv for custom commands:"
